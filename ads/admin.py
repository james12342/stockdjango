...
from .models import AdViewerActivity
...
class AdsAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'title', 'postADPaymentReceiveStatus', 'author', 'category', 'date_created', 'is_featured', 'is_active')
...
admin.site.register(postIPaddress)
admin.site.register(postADViewerIP)
admin.site.register(AdViewerActivity)
